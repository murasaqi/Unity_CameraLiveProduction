...
namespace CameraLiveProduction
{
    ...
    public class CameraMixerEditor : Editor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            outputThumbnail = new RenderTexture((int)(cameraMixer.width * 0.1f), (int)(cameraMixer.height * 0.1), 0,
            ...
            resolutionScaleField.RegisterValueChangedCallback((v) => { cameraMixer.InitRenderTextures(); });
            ...
            popUpField1.index = cameraMixer.camera1Queue == null
                ? -1
                : cameraMixer.cameraList.IndexOf(cameraMixer.camera1Queue);
            popUpField1.RegisterValueChangedCallback((v) =>
            {
                ...
                cameraMixer.camera1Queue = index >= 0 && index < cameraMixer.cameraList.Count
                    ? cameraMixer.cameraList[index]
                    : null;
            });
            popUpField2 = root.Q<DropdownField>("CameraList2");
            popUpField2.choices = cameraList;
            popUpField2.index = cameraMixer.camera2Queue == null
                ? -1
                : cameraMixer.cameraList.IndexOf(cameraMixer.camera2Queue);
            popUpField2.RegisterValueChangedCallback((v) =>
            {
                ...
                cameraMixer.camera2Queue = index >= 0 && index < cameraMixer.cameraList.Count
                    ? cameraMixer.cameraList[index]
                    : null;
            });
